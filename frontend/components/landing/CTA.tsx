    ...
    return (
        <section className="bg-[#E8ECF0] px-6 md:px-10 py-20 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3.5">
                <button onClick={handleGoogleLogin} className="bg-[#2D4A5E] text-[#F4F6F7] text-[14px] font-medium px-7 py-3 rounded-lg shadow-[0_0_0_0_rgba(45,74,94,0.4)] animate-[pulse-shadow_3.5s_ease-in-out_infinite]">
                    Continue with Google
                </button>
                <Link href={"/signup"} className="border border-[#2D4A5E] text-[#2D4A5E] text-[14px] px-7 py-3 rounded-lg">
                    Sign up with email
                </Link>
            </div>
